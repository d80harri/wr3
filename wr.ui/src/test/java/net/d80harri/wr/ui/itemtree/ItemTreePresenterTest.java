...
public class ItemTreePresenterTest {
	...
	public void addRootNode() {
		...
		ItemCellPresenter root1 = new ItemCellPresenter(null, null);
	...
	public void addNodeAfterActive() {
		ItemTreePresenter tree = new ItemTreePresenter(null, null);
		ItemCellPresenter root1 = new ItemCellPresenter(null, null);
		ItemCellPresenter root2 = new ItemCellPresenter(null, null);
	...
	public void setActiveToItemThatDoesNotExist() {
		ItemTreePresenter tree = new ItemTreePresenter(null, null);
		ItemCellPresenter root1 = new ItemCellPresenter(null, null);
		ItemCellPresenter notExisting = new ItemCellPresenter(null, null);
